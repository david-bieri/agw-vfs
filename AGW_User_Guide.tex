...
Die zugrundeliegenden Daten basieren auf den Konferenzbänden des AGW und wurden durch Text-Mining, Netzwerkanalyse und manuelle Kuration aufbereitet. Die Plattform bietet fünf Hauptperspektiven auf diese Daten: den \textit{Atlas}, \textit{Analysen}, \textit{Netzwerke}, den \textit{Zeitverlauf} und eine geführte \textit{Erzählung}.
...
\subsection{Erzählung (Scrollytelling)}
Eine kuratierte Datenreise, die quantitative Befunde dogmenhistorisch einordnet. Sie behandelt die Dominanz der Klassik in den 1980ern, das "Austrian Revival" \cite{vaughn1994}, Schumpeters Rolle als Brückenfigur und die Pluralisierung des Diskurses nach der Jahrtausendwende.
...
The underlying data is based on the published conference proceedings of the AGW, processed through text mining, network analysis, and manual curation. The platform offers five main perspectives on this data: the \textit{Atlas}, \textit{Analytics}, \textit{Networks}, \textit{Timeline}, and a guided \textit{Narrative}.
...
\subsection{Narrative (Scrollytelling)}
A curated data journey that contextualizes quantitative findings within the history of economic thought. It covers the dominance of the Classics in the 1980s, the "Austrian Revival" \cite{vaughn1994}, Schumpeter's role as a bridge figure, and the pluralization of discourse after the millennium.
