...
(function () {
  ...
  window.AGW.S = {
    ...
    gal_next:            { de: 'Nächstes Bild',           en: 'Next image' },
    ...
    card_fri3_title        : { en: 'Evening Lecture: Raphael\'s School of Athens' },
    card_fri3_text         : { en: '<span><strong>Bertram Schefold</strong> (Goethe University Frankfurt): <em>Raphael\'s School of Athens — Where Economics Hides at the Margins of Greek Philosophy.</em> Evening lecture following the Apericena.</span>' },
    ...
    ts1_detail             : { en: 'Several departures per hour (S10/S90) · Journey time approx. 15 min.' },
    ...
    train_fri              : { en: 'Depart Lugano HB 08:06 · Arrive 08:21 (9:00 start)' },
    train_sat              : { en: 'Depart Lugano HB 08:36 · Arrive 08:51 (9:15 start)' },
    ...
    prog_title_schefold : { en: '<em>Raffaels Schule von Athen</em> <span class="title-trans">— Raphael\'s School of Athens: Where Economics Hides at the Margins of Greek Philosophy</span>' },
    prog_schefold_note  : { en: 'Evening lecture following the Apericena' },
    ...
    hero_pill_concluded  : { de: 'Tagung abgeschlossen', en: 'Concluded' },
    sec_lbl_review       : { de: 'R\u00fcckblick', en: 'In Retrospect' },
    jt_review_title      : { de: 'Nach der Tagung', en: 'After the Conference' },
    jt_review_body       : { de: 'Die 46. Jahrestagung des AGW ist abgeschlossen. Der Tagungsband befindet sich in Vorbereitung und wird nach Erscheinen im Bereich Forschung verlinkt.', en: 'The 46th AGW Annual Meeting has concluded. The proceedings volume is in preparation and will be linked under Forschung (Research) once published.' },
    jt_all_events        : { de: 'Alle Veranstaltungen \u2192', en: 'All events \u2192' },
    // ── Landing / home page ──────────────────────────────────────────────
    home_hero_eyebrow    : { de: 'Verein für Socialpolitik', en: 'German Economic Association' },
    home_hero_title      : { de: 'Ausschuss für die Geschichte der Wirtschaftswissenschaften', en: 'Committee for the History of Economics' },
    home_hero_sub        : { de: 'Forschung, Tagungen und Vernetzung zur Geschichte des ökonomischen Denkens — von den Klassikern bis zur Gegenwart.', en: 'Research, conferences, and community for the history of economic thought — from the classics to the present.' },
    home_rot_label       : { de: 'Was uns beschäftigt', en: 'What occupies us' },
    home_next_label      : { de: 'Termin', en: 'Upcoming' },
    home_next_title      : { de: 'Nächste Jahrestagung', en: 'Next Annual Meeting' },
    home_areas_label     : { de: 'Bereiche', en: 'Sections' },
    home_areas_title     : { de: 'Wegweiser', en: 'Find your way' },
    home_gw_research_desc : { de: 'Tagungsbände, Publikationen und die Forschung der Mitglieder zur Theoriegeschichte.', en: "Proceedings, publications, and members' research on the history of economic thought." },
    home_gw_events_desc  : { de: 'Jahrestagungen des AGW sowie affiliierte Tagungen, Seminare und Netzwerke.', en: 'AGW annual meetings alongside affiliated conferences, seminars, and networks.' },
    home_gw_committee_desc : { de: 'Auftrag, Geschichte, Mitglieder, Vorsitz und Satzung des Ausschusses.', en: 'Mission, history, members, chair, and statutes of the committee.' },
    home_gw_cta          : { de: 'Öffnen →', en: 'Open →' },
    home_recent_title    : { de: 'Jüngste Jahrestagung', en: 'Most Recent Annual Meeting' },
    home_recent_kicker   : { de: '46. Jahrestagung · Juni 2026 · Riva San Vitale', en: '46th Annual Meeting · June 2026 · Riva San Vitale' },
    home_recent_theme    : { de: 'Zukunftsperspektiven der Theoriegeschichte: Methoden, Themen, Kontroversen', en: 'Future Perspectives in the History of Economic Thought: Methods, Topics, Controversies' },
    home_recent_cta      : { de: 'Zur Tagungsseite →', en: 'To the conference page →' },
    home_glance_label    : { de: 'Ausschuss', en: 'Committee' },
    home_glance_title    : { de: 'Auf einen Blick', en: 'At a glance' },
