...
function EraView({ selSchool }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { overflowX: "auto", padding: "16px 0" }, children: [
    ...
    /* @__PURE__ */ jsx("div", { style: { marginTop: 8, padding: "6px 12px", fontSize: 9.5, color: "rgba(200,200,216,0.45)", fontStyle: "italic", lineHeight: 1.5, maxWidth: 600 }, children: lang.t(
      "Note: Showing " + FIGS_ALL.length + " figures cited \u226510 times across all 43 conferences. Figures discussed in single papers with fewer cumulative citations may not appear individually.",
      "Hinweis: Angezeigt werden " + FIGS_ALL.length + " Figuren mit \u226510 Gesamtzitationen \xFCber alle 43 Tagungen. Figuren, die nur in einzelnen Vortr\xE4gen mit wenigen kumulativen Zitationen besprochen wurden, erscheinen m\xF6glicherweise nicht einzeln."
    ) })
  ] });
}
